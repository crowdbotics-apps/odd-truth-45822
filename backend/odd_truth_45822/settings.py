"""
Django settings for odd_truth_45822 project.
...
ROOT_URLCONF = 'odd_truth_45822.urls'
...
WSGI_APPLICATION = 'odd_truth_45822.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_truth_45822 API",
    "DESCRIPTION": "API documentation for odd_truth_45822 App",
    "VERSION": "v1",
}
